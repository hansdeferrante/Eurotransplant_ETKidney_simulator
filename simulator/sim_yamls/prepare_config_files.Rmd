...
SIM_END_DATE <- '2016-01-01'
BALANCE_START_DATE <- '2014-01-01'
```
...
settings <- expand_grid(
  ...
  mutate(balance_start_time = BALANCE_START_DATE) |>
...
prepare_config_file <- function(sim_name, sim_seed, sim_start_date, kth_stat, save_match_lists,
                                ...
                                store_components, balance_start_time, sim_end_date,
                                date = Sys.Date(), ...) {
