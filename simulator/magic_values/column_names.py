...
OFFERED_TO_CENTER = 'offered_to_center'
OFFERED_TO_PATIENT = 'offered_to_patient'
CENTER_RESCUE_OFFER = 'center_rescue_offer'
PATIENT_RESCUE_OFFER = 'patient_rescue_offer'
